...
MetaDonnee creationFichier(int choix); //1 pour chainee et 2 pour contigue
...
int AllouerBlocChainee(int i); //Alloue un bloc a partir de l'indice i
int AllouerBlocContigue(int i);
